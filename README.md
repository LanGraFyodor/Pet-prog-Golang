...
В этом репозитории собраны результаты моих pet-проектов/курсов/работ.      
Каждый проект представлен в отдельном модуле: что делает код, как устроено «под капотом», какие ключевые файлы за что отвечают, стек.
